...
// console.log(generateGalleryMarkup(images));


// Ініціалізація SimpleLightbox після додавання зображень
let galleryWithCap = new SimpleLightbox('.gallery a', {
  captionsData: 'alt', // Виводити підписи з атрибуту alt
  captionDelay: 250, // Затримка перед появою підпису
});

galleryWithCap.refresh();